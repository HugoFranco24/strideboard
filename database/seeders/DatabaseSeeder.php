...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $users = [
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Hugo Franco', 'email' => 'franco.carreira.hugo@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Delfim Franco', 'email' => 'franco.carreira.delfim@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Fábio Franco', 'email' => 'franco.carreira.fabio@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Martim Borges', 'email' => 'martim.duarte.borges@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'João Brás', 'email' => 'joao.antunes.bras@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Andrylls Carvalho', 'email' => 'andrylls112@gmail.com', 'password' => Hash::make('123456789')],
            ['pfp' => 'Images/Pfp/pfp_default.png', 'name' => 'Strideboard', 'email' => 'strideboard.web@gmail.com', 'password' => Hash::make('123456789')],
        ];
