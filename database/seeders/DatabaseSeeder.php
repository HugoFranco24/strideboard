...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $users = [
            ['name' => 'Hugo Franco', 'email' => 'franco.carreira.hugo@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'Delfim Franco', 'email' => 'franco.carreira.delfim@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'Fábio Franco', 'email' => 'franco.carreira.fabio@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'Martim Borges', 'email' => 'martim.duarte.borges@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'João Brás', 'email' => 'joao.antunes.bras@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'Andrylls Carvalho', 'email' => 'andrylls112@gmail.com', 'password' => Hash::make('123456789')],
            ['name' => 'Strideboard', 'email' => 'strideboard.web@gmail.com', 'password' => Hash::make('123456789')],
        ];
