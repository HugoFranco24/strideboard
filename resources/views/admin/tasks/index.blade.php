...
@section('main-content')
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="overflow-x-auto" style="max-height: 80dvh">
                ...
                <tbody>
                    @foreach ($tasks as $t)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">{{ $t->project->name }}</td>
                            ...
                            <td class="px-6 py-6 flex space-x-2">
                                <button class="cursor-pointer bg-gray-800 hover:bg-gray-950 text-white font-semibold py-1 px-3 rounded transition duration-200" onclick="alert('Edit user 1')">Edit</button>
                                <button class="cursor-pointer bg-red-700 hover:bg-red-800 text-white font-semibold py-1 px-3 rounded transition duration-200" onclick="if(confirm('Delete user?')) alert('User 1 deleted')">Delete</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
